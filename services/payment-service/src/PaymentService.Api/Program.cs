...
{
    o.SwaggerDoc("v1", new OpenApiInfo { Title = "Payment Service", Version = "v1" });
...
await PaymentService.Infrastructure.DependencyInjection.InitializeDatabaseAsync(app.Services);
