...
{
    o.SwaggerDoc("v1", new OpenApiInfo { Title = "Chat Service", Version = "v1" });
...
await ChatService.Infrastructure.DependencyInjection.InitializeDatabaseAsync(app.Services);
