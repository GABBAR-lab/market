...
{
    o.SwaggerDoc("v1", new OpenApiInfo { Title = "Notification Service", Version = "v1" });
...
await NotificationService.Infrastructure.DependencyInjection.InitializeDatabaseAsync(app.Services);
